...
Deployment resource group name is auto-generated from `<org_prefix>-<environment>-rg-<region_code>`.
...
- Creates a new deployment resource group (`<org_prefix>-<environment>-rg-<region_code>`)
